...
<head>
    <meta charset="UTF-8">
    <title>添加商品-后台管理系统-Admin 1.0</title>
...
<div class="weadmin-body">
    <form class="layui-form">
       <%-- <div class="layui-form-item">
        ...
        <div class="layui-form-item">
           ...
           <div class="layui-form-item">
               <label for="shop_price" class="layui-form-label">
                   <span class="we-red">*</span>市场价格</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item">
            <label for="pflag" class="layui-form-label">
        ...
        <%--<div class="layui-form-item">
           ...
           <div class="layui-form-item layui-form-text">
               ...
               <div class="layui-input-block">
                   <textarea placeholder="请输入描述" id="pdesc" name="pdesc" class="layui-textarea"></textarea>
               </div>
           </div>
          <%-- <div class="layui-form-item layui-form-text">
...
//        });
        ...
        $.ajax({
            ...
            success:function(data){
                $('#cid').append(new Option("请选择",null));
