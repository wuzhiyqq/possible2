...
<head>
    <meta charset="UTF-8">
    <title>修改商品-后台管理系统-Admin 1.0</title>
...
<div class="weadmin-body">
    <form class="layui-form">
       <%-- <div class="layui-form-item">
           ...
           <div class="layui-form-item">
               <label for="cid" class="layui-form-label"><span class="we-red">*</span>商品类别</label >
               <div class="layui-input-inline" lay-filter="feilei">
                   <select name="cid" id="cid" lay-verify="required" autocomplete="off" class="layui-input" ></select>
                   <input type="hidden" id="dataCid" />
               </div>
           </div>
           <div class="layui-form-item">
               <label for="pname" class="layui-form-label"><span class="we-red">*</span>商品名称</label>
               <div class="layui-input-block">
           ...
           <div class="layui-form-item">
               <label for="shop_price" class="layui-form-label"><span class="we-red">*</span>市场价格</label>
               <div class="layui-input-block">
           ...
           <div class="layui-form-item">
               <label for="shop_price" class="layui-form-label"><span class="we-red">*</span>商店价格</label>
               <div class="layui-input-block">
           ...
           <div class="layui-form-item">
               <label for="pflag" class="layui-form-label"><span class="we-red">*</span>商品库存</label>
               <div class="layui-input-block">
                    ...
                    if(message>0){
                        layer.alert("修改成功", {
                           ...
                           parent.layer.close(index);
                            $(".layui-laypage-btn" , parent.document).click();//刷新父页面,刷新原始页面.
                           // parent.location.reload(); //刷新父页面,刷新整个页面
                        });
                    }
